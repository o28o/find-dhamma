...
<title>Dhamma Find - All Encompassing Search of the Buddhas Teaching</title>
 ...
 */		}
    ...
    $gender = test_input($_POST["gender"]);
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase" id="mainNav">
            <a class="navbar-brand" href="#page-top"> <div class="container"><img src="assets/dhammafindlogo.png"  style="width:100px;"></a>
